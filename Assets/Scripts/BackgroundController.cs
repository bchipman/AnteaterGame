...
public class BackgroundController : MonoBehaviour {
	...
	void Start () {
        ...
        // ahead
        spriteRendererSky2.transform.position = new Vector3(boundsSky1.max.x + boundsSky2.extents.x - 0.1f, 0, 0);

        // behind
        boundsSky0 = spriteRendererSky0.bounds;
        boundsSky1 = spriteRendererSky1.bounds;
        spriteRendererSky0.transform.position = new Vector3(boundsSky1.min.x - boundsSky0.extents.x + 0.1f, 0, 0);
	}
	...
	void Update () {
        ...
        if (player.transform.position.x > b1.max.x) {
            ...
            spriteRendererSky0.transform.position = new Vector3(b2.max.x + b0.extents.x - 0.1f, 0, 0);
            ...
            spriteRendererSky2.transform.position = new Vector3(b0.min.x - b2.extents.x + 0.1f, 0, 0);
